...
/** This class defines all action handlers and stores data used in the Modify Product Screen. */
...
public class ModifyProductController {
    ...
    void saveHandler(ActionEvent event) throws IOException {
        try {
            ...
            if(!error) {
                ...
                Product saveProduct = new Product(id, name, price, inv, min, max, partsList);

                Inventory.updateProduct(index, saveProduct);

                stage = (Stage) ((Button) event.getSource()).getScene().getWindow();
                scene = FXMLLoader.load(getClass().getResource("/View_Controller/main_screen.fxml"));
                stage.setScene(new Scene(scene, 1098, 493));
                stage.show();
                productAssociatedParts.clear();
            }
        }
    ...
    /**
     * Passes in a product parameter from the Main Screen and sets the values for the text fields
     * @param pr the product to modify
     */
    public void setProduct(Product pr){
        ...
        productAssociatedParts.setAll(product.getAllAssociatedParts());
    ...
    void initialize() {
        ...
        assert productidfield != null : "fx:id=\"productidfield\" was not injected: check your FXML file 'modify_product.fxml'.";
        assert productpricefield != null : "fx:id=\"productpricefield\" was not injected: check your FXML file 'modify_product.fxml'.";
        assert productinvfield != null : "fx:id=\"productinvfield\" was not injected: check your FXML file 'modify_product.fxml'.";
        assert productnamefield != null : "fx:id=\"productnamefield\" was not injected: check your FXML file 'modify_product.fxml'.";
        assert productmaxfield != null : "fx:id=\"productmaxfield\" was not injected: check your FXML file 'modify_product.fxml'.";
        assert productminfield != null : "fx:id=\"productminfield\" was not injected: check your FXML file 'modify_product.fxml'.";
        assert partsearch != null : "fx:id=\"partsearch\" was not injected: check your FXML file 'modify_product.fxml'.";
        assert partsTableView != null : "fx:id=\"partsTableView\" was not injected: check your FXML file 'main_screen.fxml'.";
        assert partid != null : "fx:id=\"partid\" was not injected: check your FXML file 'modify_product.fxml'.";
        assert partname != null : "fx:id=\"partname\" was not injected: check your FXML file 'modify_product.fxml'.";
        assert partinventorylevel != null : "fx:id=\"partinventorylevel\" was not injected: check your FXML file 'modify_product.fxml'.";
        assert partprice != null : "fx:id=\"partprice\" was not injected: check your FXML file 'modify_product.fxml'.";
        assert associatedPartsTableView != null : "fx:id=\"associatedPartsTableView\" was not injected: check your FXML file 'main_screen.fxml'.";
        assert associatedpartid != null : "fx:id=\"associatedpartid\" was not injected: check your FXML file 'modify_product.fxml'.";
        assert associatedpartname != null : "fx:id=\"associatedpartname\" was not injected: check your FXML file 'modify_product.fxml'.";
        assert associatedpartinventorylevel != null : "fx:id=\"associatedpartinventorylevel\" was not injected: check your FXML file 'modify_product.fxml'.";
        assert associatedpartprice != null : "fx:id=\"associatedpartprice\" was not injected: check your FXML file 'modify_product.fxml'.";
